...
import com.lxb.dao.Dao;
import com.lxb.service.Service;
...
public class BasicFactory {
	...
	private static String path = BasicFactory.class.getClassLoader().getResource("/config/config.properties").getPath();
